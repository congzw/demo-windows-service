...
namespace Common.WindowsServices
{
    ...
    {
        public WsController(string exePath, string serviceName, string displayName = null)
        {
            if (exePath == null)
            {
        ...
        public static WsController Create(string exePath, string serviceName, string displayName = null)
        {
            return new WsController(exePath, serviceName, displayName);
        }
